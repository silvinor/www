...
Which produces a small irony worth sitting with. If normal has to be put on, it is not normal - not in the sense the word implies, of a natural default that some people simply fail to reach.

So what is it instead? On this evidence, normal is a settlement. It is the point at which a particular group has converged on what acceptable looks like, and then stopped noticing that it converged on anything at all. That makes it real, and enforced, and entirely local.

Local is the operative word, because the settlement varies. Gelfand and colleagues surveyed 33 nations and found societies differ systematically in what they termed tightness - the strength of their social norms and how much deviation they will tolerate - with tight societies enforcing a narrow band of behaviour and loose ones permitting a wide one. [^7] The same conduct is unremarkable in one population and sanctioned in another. And it scales down from there. A trading floor and a primary school staffroom are different settlements. So are a family, a profession, a generation, a friendship group.

This changes what the autistic difficulty actually is, so it is worth being exact. If normal were a single natural standard, failing it would be a defect. It is not one. Every room is running a local convention that was settled before you arrived and is mostly unwritten. The task is therefore not to be normal, because there is no such thing to be. The task is to work out, in real time and without being told, which settlement is operating here - and that reading is precisely what the disability restricts.
...
Social masking is less scripted than the workplace version and, several autistic participants reported, harder for exactly that reason. [^8]
...
If normal is a convention that a group arrived at socially, transmits socially, and has stopped noticing it holds, then locating it is a social-reading task. Not performing it - locating it. Those are different jobs, and only the first one is optional.

Now read the diagnostic criteria against that. Autism is defined by *persistent* deficits in social communication and social interaction "across multiple contexts", and one of the three required sub-criteria is deficits in developing, maintaining and understanding relationships - illustrated, first among its examples, by "difficulties adjusting behavior to suit various social contexts". [^34] All three sub-criteria have to be met; unlike the restricted-and-repetitive-behaviour criterion, where two of four will do, this one admits no partial credit. [^35] So while the context-adjustment wording is an illustration rather than a box to tick, the domain it illustrates is compulsory. Nobody arrives at an autism diagnosis without a documented difficulty in exactly this area.

That is not an incidental item on a list. It is the settlement-detection problem, written into the diagnostic manual - and the phrase "across multiple contexts" sits in the criterion heading, not the footnotes.

Which means the failure is not really one of performance. A great many autistic people execute a convention well once they know what it is; the scripts, the timing, the register are all learnable. The failure is upstream of that, in finding the thing to execute. And a convention that was established socially, is maintained socially, and is invisible to the very people enforcing it, is the hardest possible object for someone with restricted social reading to detect.

So the mask is not badly performed. It is well performed against a specification that was inferred with the wrong instrument. A proportion of it comes out wrong for that reason alone, before any question of effort or skill arises.

That produces a prediction, and the evidence already matches it: where the settlement is written down, autistic masking should work better; where it has to be inferred, it should fail. This is precisely what the Pryke-Hobbes participants describe. Several found workplace masking *easier* than social masking, because professional roles arrive with explicit rules - one said that with the right knowledge you can basically learn the script for your role. Social settings left people "more at sea", and one participant said that if friends supplied a written contract and a job description, they might be better at friendship. [^8] The variable is not how much social skill the situation demands. It is whether the local settlement has been published.

The wrongness is not subtle and it is not slow. Sasson and colleagues showed observers brief clips of autistic and non-autistic adults and found autistic people rated less favourably across a range of traits, with reduced intentions to interact with them - and the judgements formed within seconds. [^36] The finding that matters most is what happened when the audiovisual cues were removed: with only the content of what was said, the bias disappeared. Observers were not reacting to what autistic people said. They were reacting to how it was delivered.
...
Cage and Troxell-Whitman asked 262 autistic adults about camouflaging across contexts - work against family, formal against informal - and found something important about the pattern rather than the amount. Both camouflaging heavily across all contexts *and* switching between camouflaging in some contexts and not others were associated with poorer mental health. [^39] The switching is its own cost, separate from the volume.

That finding is what the settlement account predicts, and it is worth being precise about why. Each context is not more of the same task. It is a separate convention, which has to be located separately, held separately, and checked separately against the room - and then kept from leaking into the others. So the load does not accumulate by addition. Two settings are not twice one setting, because the two also have to be told apart and held apart. Add a third and a fourth, each with its own unpublished rules and its own audience who would notice a slip, and the demand outruns what anyone could meet - which is roughly the point at which the mask stops being a strategy and starts being the thing that is consuming the person.
...
Abramson, Seligman and Teasdale set out the framework in 1978. When people explain negative events, the explanations vary along three dimensions: internal or external, stable or unstable, global or specific. The combination that produces the most damage - depression, and the generalisation of helplessness across situations - is internal, stable and global. Not *that went badly*, but *I am the kind of thing that goes badly, and always will, everywhere*. [^48]
...
This is not only a vague hypothesis. Riebel and colleagues surveyed 689 autistic adults on self-stigma, self-compassion, camouflaging and depression, and found that self-stigma raised depressive symptoms *through* shame - shame as the mediating pathway, not an incidental feeling alongside it. [^50] Botha and Frost's minority stress account puts the same finding in its social context: the damage tracks stigma, concealment and social position rather than the neurology. [^31]

The repair is slow and it starts late. Corden, Brewer and Cage surveyed 151 autistic adults on identity, self-esteem and wellbeing after diagnosis, and found that more time elapsed since diagnosis related to less dissatisfaction with autistic identity. [^51] Read that the other way round and it is bleak: the work of not despising yourself for being autistic cannot begin until someone tells you that you are, and then it takes years.
...
**It never converts.** Neurotypical presentation mostly becomes the person - deep acting, absorbed, cheap to run. The autistic version stays surface acting, held up by explicit reasoning, in real time, with the cost landing in the same moment and registering in the body. [^12][^15][^17][^18] Habit may remove the decision, but it does not remove the bill.
...
[^7]: Gelfand, M. J., Raver, J. L., Nishii, L., Leslie, L. M., Lun, J., Lim, B. C., Duan, L., Almaliach, A., Ang, S., Arnadottir, J., Aycan, Z., Boehnke, K., Boski, P., Cabecinhas, R., Chan, D., Chhokar, J., D'Amato, A., Subirats Ferrer, M., Fischlmayr, I. C., … Yamaguchi, S. (2011). Differences between tight and loose cultures: A 33-nation study. *Science*, *332*(6033), 1100–1104. [DOI: 10.1126/science.1197754](https://doi.org/10.1126/science.1197754)

[^8]: Pryke-Hobbes, A., Davies, J., Heasman, B., Livesey, A., Walker, A., Pellicano, E., & Remington, A. (2023). The workplace masking experiences of autistic, non-autistic neurodivergent and neurotypical adults in the UK. *PLOS ONE*, *18*(9), e0290001. [DOI: 10.1371/journal.pone.0290001](https://doi.org/10.1371/journal.pone.0290001)

[^9]: Miller, D., Rees, J., & Pearson, A. (2021). "Masking is life": Experiences of masking in autistic and nonautistic adults. *Autism in Adulthood*, *3*(4), 330–338. [DOI: 10.1089/aut.2020.0083](https://doi.org/10.1089/aut.2020.0083)

[^10]: van der Putten, W. J., Mol, A. J. J., Groenman, A. P., Radhoe, T. A., Torenvliet, C., Agelink van Rentergem, J. A., & Geurts, H. M. (2024). Is camouflaging unique for autism? A comparison of camouflaging between adults with autism and ADHD. *Autism Research*, *17*(4), 812–823. [DOI: 10.1002/aur.3099](https://doi.org/10.1002/aur.3099)

[^22]: Baumeister, R. F., & Leary, M. R. (1995). The need to belong: Desire for interpersonal attachments as a fundamental human motivation. *Psychological Bulletin*, *117*(3), 497–529. [DOI: 10.1037/0033-2909.117.3.497](https://doi.org/10.1037/0033-2909.117.3.497)

[^23]: Milton, D., & Sims, T. (2016). How is a sense of well-being and belonging constructed in the accounts of autistic adults? *Disability & Society*, *31*(4), 520–534. [DOI: 10.1080/09687599.2016.1186529](https://doi.org/10.1080/09687599.2016.1186529)

[^24]: Umagami, K., Remington, A., Lloyd-Evans, B., Davies, J., & Crane, L. (2022). Loneliness in autistic adults: A systematic review. *Autism*, *26*(8), 2117–2135. [DOI: 10.1177/13623613221077721](https://doi.org/10.1177/13623613221077721)

[^25]: Cage, E., Di Monaco, J., & Newell, V. (2018). Experiences of autism acceptance and mental health in autistic adults. *Journal of Autism and Developmental Disorders*, *48*(2), 473–484. [DOI: 10.1007/s10803-017-3342-7](https://doi.org/10.1007/s10803-017-3342-7)

[^26]: Botha, M., Dibb, B., & Frost, D. M. (2022). "Autism is me": An investigation of how autistic individuals make sense of autism and stigma. *Disability & Society*, *37*(3), 427–453. [DOI: 10.1080/09687599.2020.1822782](https://doi.org/10.1080/09687599.2020.1822782)

[^27]: Pearson, A., & Rose, K. (2021). A conceptual analysis of autistic masking: Understanding the narrative of stigma and the illusion of choice. *Autism in Adulthood*, *3*(1), 52–60. [DOI: 10.1089/aut.2020.0043](https://doi.org/10.1089/aut.2020.0043)

[^28]: Perry, E., Mandy, W., Hull, L., & Cage, E. (2022). Understanding camouflaging as a response to autism-related stigma: A social identity theory approach. *Journal of Autism and Developmental Disorders*, *52*(2), 800–810. [DOI: 10.1007/s10803-021-04987-w](https://doi.org/10.1007/s10803-021-04987-w)

[^29]: Van Orden, K. A., Witte, T. K., Cukrowicz, K. C., Braithwaite, S. R., Selby, E. A., & Joiner, T. E. (2010). The interpersonal theory of suicide. *Psychological Review*, *117*(2), 575–600. [DOI: 10.1037/a0018697](https://doi.org/10.1037/a0018697)

[^30]: Cassidy, S. A., Gould, K., Townsend, E., Pelton, M., Robertson, A. E., & Rodgers, J. (2020). Is camouflaging autistic traits associated with suicidal thoughts and behaviours? Expanding the interpersonal psychological theory of suicide in an undergraduate student sample. *Journal of Autism and Developmental Disorders*, *50*(10), 3638–3648. [DOI: 10.1007/s10803-019-04323-3](https://doi.org/10.1007/s10803-019-04323-3)

[^31]: Botha, M., & Frost, D. M. (2020). Extending the minority stress model to understand mental health problems experienced by the autistic population. *Society and Mental Health*, *10*(1), 20–34. [DOI: 10.1177/2156869318804297](https://doi.org/10.1177/2156869318804297)

[^32]: Milton, D. E. M. (2012). On the ontological status of autism: The 'double empathy problem'. *Disability & Society*, *27*(6), 883–887. [DOI: 10.1080/09687599.2012.710008](https://doi.org/10.1080/09687599.2012.710008)
...
[^36]: Sasson, N. J., Faso, D. J., Nugent, J., Lovell, S., Kennedy, D. P., & Grossman, R. B. (2017). Neurotypical peers are less willing to interact with those with autism based on thin slice judgments. *Scientific Reports*, *7*, 40700. [DOI: 10.1038/srep40700](https://doi.org/10.1038/srep40700)

